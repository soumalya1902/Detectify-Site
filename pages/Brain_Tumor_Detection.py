...
if x:
    with st.spinner("Detecting..."):
        y,conf = imagerec.imagerecognise(uploaded_file,"Models/brain_tumor.h5","Models/brain_tumor.txt")
    if y.strip() == "normal":
        components.html(
            """
            <style>
        ...
        components.html(
            ...
            <h1>Meningioma Tumor Detected</h1>
            """
        )
    else:
        components.html(
            ...
            <h1>Pituitary Tumor Detected</h1>
            """
        )
